...
public class SpigotListeners implements Listener {
    ...
    public void onAsyncChat(AsyncPlayerChatEvent e) {
        ...
        String username = DiscordMessageFormat.Chat.Normal.username(message, playerName);
        String avatarURL = "https://crafatar.com/avatars/playerUUID?overlay".replace("playerUUID", e.getPlayer().getUniqueId().toString().replaceAll("-", ""));
        String content = DiscordMessageFormat.Chat.Normal.message(message, playerName);
